...
- Transformed binary values into readable labels (Yes/No)
...
- Churn distribution by:
  ...
  - Contract type
  - Payment method
  - Internet services and add-on features
...
- Lack of **online security, backup, or tech support** increases churn
